...
async function runAIPipeline({
  ...
  try {
    ...
    if (msg.includes("Not logged in") || msg.includes("Unauthorized") || msg.includes("API token")) {
      console.warn("Wrangler not logged in. Falling back to local mock AI pipeline.");
      fallbackMode = true;
...
function buildSystemPrompt(aiConfig) {
  ...
  if (userName) {
    parts.push(`The user's preferred name is ${userName}. Address them naturally by this name when appropriate.`);
  }
...
// .wrangler/tmp/bundle-hFEt9e/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-hFEt9e/middleware-loader.entry.ts
